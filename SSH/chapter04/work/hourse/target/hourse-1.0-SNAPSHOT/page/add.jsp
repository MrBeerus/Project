				...
				<div class="infos">
					<table class="field">
						<tr>
							...
							<td>
							<input cssClass="text" key="title" name="title"/>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input cssClass="text" key="floorage" name="floorage"/></td>
						</tr>
						<tr>
							<td class="field">价　　格：</td>
							<td>
							<input cssClass="text" key="price" name="price"/>
							</td>
						</tr>
                        ...
                        <tr>
							...
							<td>
							<input cssClass="text" key="contact" name="contact"/>
							</td>
						</tr>
                        <tr>
