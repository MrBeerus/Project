...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		var i=parseInt(<s:property value="voucher.voucherDetalls.size"/>);
		
		var rowNumber=parseInt(<s:property value="voucher.voucherDetalls.size"/>);
		var totalAccount = <s:property value="voucher.totalAccount"/>;
		function delRow(id){	
	...
	<div class="action  divaction">
		...
		<div class="pages">
			<s:form action="updateVoucher.action" name="claimForm">
			
			<input type="hidden" id="rowNumber" name="rowNumber" value="<s:property value="rowNumber"/>"/>
			<input type="hidden" id="claimId" name="voucher.id" value="<s:property value="voucher.id"/>"/>
				<table width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base">
                  ...
                  <tr>
                    <td>总金额：
						<input type="text" name="voucher.totalAccount" value="<s:property value="voucher.totalAccount"/>" id="totalAccount" readonly="readonly"/>
                    ...
                    <s:hidden id="status" name="voucher.status" value="%{claimVoucher.status}"/>
                  </tr>
                  <tr>
                  	<td colspan="4"><p>-------------------------------------------------------------------------------</p></td>
                  </tr>
				...
				<table id="myTable" width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base">
					...
					<s:iterator value="detailList" id="claimDetail" begin="0" status="s">
					<tr>
						<td>
				...
				<table id="detailTable" width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base">
					<tr>
						...
						<td width="30%"><input type="text" name="voucher.des" id="desc" /><span class=notice>*</span></td>
				...
				<table>
					<tr>
						<td>*事由：</td>
						<td colspan="3">
						<s:textarea name="voucher.event" id="event" rows="5" cols="66"></s:textarea>
						</td>
					</tr>
