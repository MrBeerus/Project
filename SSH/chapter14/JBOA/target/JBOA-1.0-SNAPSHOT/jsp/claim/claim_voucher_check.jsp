...
<body>
    ...
    <s:form action="checkRescultVoucher.action" name="checkResultForm">
    <table width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base">
		<tr>
			<td>
				审批意见：<input type="hidden" name="voucher.id" value="<s:property value="voucher.id"/>"/>
			</td>
		</tr>
		<tr>
			<td>
		 ...
		 <tr>
			<td colspan="3" class="submit">
				...
				<s:if test='#session.emp.position.nameCn != "财务"'>
