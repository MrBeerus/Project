...
<div class="nav" id="nav">
	<div class="t"></div>
   		<dl class="open">
	           ...
	           <dd><a href="jsp/claim/listVoucher.action">查看报销单</a></dd>
	           <s:if test='#session.postion == "员工"'>
       ...
       <s:if test='#session.postion == "部门经理"'>
       <dl>
       ...
       <s:if test='#session.postion == "总经理" ||#session.postion == "财务"'>
       <dl>
       		<dt onclick="this.parentNode.className=this.parentNode.className=='open'?'':'open';">统计报表</dt>
